...
| `storage`                | Optional | [Storage](#storage) for payloads and related information. To use PostgreSQL, see [Using PostgreSQL](Using-PostgreSQL.md). To use Oracle, see [Using Oracle](Using-Oracle.md).                               | `"leveldb"`                       |
