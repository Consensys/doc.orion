...
can also disaable all your browser plugins and see if the bug still happens.
...
1. [**Fork the repository**](https://github.com/PegaSysEng/doc.orion/fork).
...
1. **Create a pull-request** (PR) on the Orion doc repository. If the PR addresses an existing Jira issue, 
include the issue number in the PR title in square brackets (for example, `[OR-1234]`). 
...
you can **"squash and merge"** your PR and you're done. You contributed to Orion documentation! Thanks !
