/*! For license information please see 1a4e3797.b4d67619.js.LICENSE.txt */
  ...
  [920],
  {
        ...
        return function (t, r) {
          var s = e.hierarchicalFacets[r],
            o =
              ...
              "",
            h = e._getHierarchicalFacetSeparator(s),
            f = e._getHierarchicalRootPath(s),
    ...
    3076: (e, t, r) => {
      ...
      var n = r(185),
        ...
        o = r(2293),
        h = r(4039),
        f = h.escapeFacetValue,
        l = h.unescapeFacetValue,
        m = r(210);
      function d(e) {
        var t = {};
        return (
      ...
      function v(e, t, r) {
        ...
        Object.keys(a).forEach(function (e) {
          ...
          (this.facets = []);
        var h = e.getRefinedDisjunctiveFacets(),
          f = d(e.facets),
        ...
        Object.keys(y).forEach(function (t) {
          ...
          if (s) {
            var h = s.attributes.indexOf(t),
              l = u(e.hierarchicalFacets, function (e) {
                return e.name === s.name;
              });
            o.hierarchicalFacets[l][h] = {
              attribute: t,
              data: i,
            ...
            d &&
              ((m = v[t]),
              (o.disjunctiveFacets[m] = {
                name: t,
                data: i,
                exhaustive: a.exhaustiveFacetsCount,
              }),
              p(o.disjunctiveFacets[m], a.facets_stats, t)),
              g &&
                ((m = f[t]),
                (o.facets[m] = {
                  name: t,
          ...
          h.forEach(function (r) {
            ...
            Object.keys(c).forEach(function (t) {
              ...
              if (h) {
                ...
                if (-1 === m) return;
                o.hierarchicalFacets[r][m].data = n(
                  {},
                ...
                (o.disjunctiveFacets[r] = {
                  ...
                  p(o.disjunctiveFacets[r], s.facets_stats, t),
          ...
          e.getRefinedHierarchicalFacets().forEach(function (r) {
            ...
            0 === s.length ||
              ...
              t.slice(g).forEach(function (t) {
                var r = t && t.facets ? t.facets : {};
                Object.keys(r).forEach(function (t) {
                  var c = r[t],
                    h = u(e.hierarchicalFacets, function (e) {
                      return e.name === n.name;
                    }),
                    f = u(o.hierarchicalFacets[h], function (e) {
                      return e.attribute === t;
                    });
                  if (-1 !== f) {
                    var l = {};
      ...
      function g(e, t) {
        ...
        if (e._state.isHierarchicalFacet(t)) {
          ...
          var s = e._state.getHierarchicalFacetByName(t),
            u = l(e._state.getHierarchicalRefinement(t)[0] || "").split(
              e._state._getHierarchicalFacetSeparator(s),
            );
          return u.unshift(t), y(a, u, 0), a;
        }
      }
      function y(e, t, r) {
      ...
      function b(e, t, r, n, i) {
        var a = c(i, function (e) {
          ...
          u = (a && a.exhaustive) || !1;
        return { type: t, attributeName: r, name: n, count: s, exhaustive: u };
      }
            ...
            return R(
              function (e, t) {
                ...
                if (Array.isArray(s.sortBy)) {
                  var n = o(s.sortBy, v.DEFAULT_SORT);
                  return a(e, n[0], n[1]);
                }
        ...
        (d.prototype.searchForFacetValues = function (e, t, r, n) {
          ...
          return (
            i
              ...
              : a
              ? (h = this.client.initIndex(c.index).searchForFacetValues(o))
              : (delete o.facetName,
                (h = this.client
                  .search([
      ...
      var a = {
              ...
              if (void 0 !== a) {
                ...
                if (t === i) {
                  if (
                    ...
                    return;
                  f
                    ? ((u = f.split(h).length - 1), (a = f))
                    : ((u = a.split(h).length - 2),
                      (a = a.slice(0, a.lastIndexOf(h)))),
                    (s = o.attributes[u]);
                } else (u = a.split(h).length - 1), (s = o.attributes[u]);
                s && n.push([s + ":" + a]);
              }
            }),
            n
        ...
        getSearchForFacetQuery: function (e, t, r, s) {
          ...
          return (
            ...
            i(n({}, a._getHitsSearchParams(c), u))
          );
        },
      };
      e.exports = a;
            ...
            return function (t, i) {
              return Promise.all(
                t.map(function (t) {
                  ...
                  }).searchForFacetValues(s, c, r(r({}, i), u));
                }),
              );
            };
          },
            ...
            a = {
              ...
              logger:
                ((i = q),
                {
                  ...
                  info: function (e, t) {
                    return I >= i && console.info(e, t), Promise.resolve();
                  },
                  error: function (e, t) {
              ...
              hostsCache: c({
                caches: [s({ key: "".concat("4.14.3", "-").concat(e) }), u()],
              }),
              userAgent: _("4.14.3").add({
                segment: "Browser",
                version: "lite",
              }),
    ...
    6675: (e, t, r) => {
      ...
      function p(e) {
        return d.filter((t) => e.includes(t));
      }
      const v = {
        locale: "en",
        pluralForms: p(["one", "other"]),
        ...
        return (0, n.useMemo)(() => {
          try {
            return (function (e) {
              ...
              return {
                locale: e,
                pluralForms: p(t.resolvedOptions().pluralCategories),
                select: (e) => t.select(e),
              };
            })(e);
          } catch (t) {
      ...
      var R = r(902),
        ...
        E = r(239),
        x = r(4774);
      const w = "searchQueryInput_u2C7",
        O = "searchVersionInput_m0Ui",
        N = "searchResultsColumn_JPFH",
        A = "algoliaLogo_rT1R",
        H = "algoliaLogoPathFill_WdUC",
        S = "searchResultItem_Tv2o",
        T = "searchResultItemHeading_KbCB",
        Q = "searchResultItemPath_lhe1",
        C = "searchResultItemSummary_AEaO",
        k = "searchQueryColumn_RTkw",
        D = "searchVersionColumn_ypXd",
        I = "searchLogoColumn_rJIA",
        q = "loadingSpinner_XVxU",
        V = "loader_vvXV";
      function L(e) {
        ...
        return n.createElement(
          "div",
          { className: (0, i.Z)("col", "col--3", "padding-left--none", D) },
          r.map((e) => {
            let [i, a] = e;
            ...
            return n.createElement(
              ...
              {
                key: i,
                onChange: (e) => t.setSearchVersion(i, e.target.value),
      ...
      function B() {
        const {
          ...
          { searchQuery: v, setSearchQuery: g } = (0, b.O)(),
          F = {
            items: [],
            query: null,
            totalResults: null,
        ...
        z.on("result", (e) => {
          let {
            results: { query: t, hits: r, page: n, nbHits: i, nbPages: a },
          } = e;
          if ("" === t || !Array.isArray(r)) return void D({ type: "reset" });
          const s = (e) =>
              e.replace(
            ...
            u = r.map((e) => {
              ...
              const i = Object.keys(r).map((e) => s(r[e].value));
              return {
                title: i.pop(),
                url: c(t),
                summary: n.content ? `${s(n.content.value)}...` : "",
                breadcrumbs: i,
              };
            });
          D({
        ...
        const [M, J] = (0, n.useState)(null),
          W = (0, n.useRef)(0),
          U = (0, n.useRef)(
            o.default.canUseIntersectionObserver &&
              new IntersectionObserver(
                (e) => {
                  ...
                  t && W.current > r && D({ type: "advance" }), (W.current = r);
                },
                { threshold: 1 },
              ),
          ),
          ...
          $ = (0, R.zX)(function (t) {
            void 0 === t && (t = 0),
              z.addDisjunctiveFacetRefinement("docusaurus_tag", "default"),
              z.addDisjunctiveFacetRefinement("language", e),
              Object.entries(p.searchVersions).forEach((e) => {
                let [t, r] = e;
                z.addDisjunctiveFacetRefinement(
                  "docusaurus_tag",
                  `docs-${t}-${r}`,
                );
              }),
              z.setQuery(v).setPage(t).search();
          });
        return (
          (0, n.useEffect)(() => {
            if (!M) return;
            const e = U.current;
            return e ? (e.observe(M), () => e.unobserve(M)) : () => !0;
          }, [M]),
          (0, n.useEffect)(() => {
            D({ type: "reset" }),
              v &&
          ...
          (0, n.useEffect)(() => {
            O.lastPage && 0 !== O.lastPage && $(O.lastPage);
          }, [$, O.lastPage]),
          n.createElement(
            x.Z,
            null,
            n.createElement(
              h.Z,
              null,
              n.createElement("title", null, (0, P.p)(Z())),
            ...
            n.createElement(
              ...
              n.createElement(
                ...
                p.versioningEnabled &&
                  n.createElement(L, { docsSearchVersionsHelpers: p }),
              ),
              n.createElement(
                "div",
                { className: "row" },
                n.createElement(
                  "div",
                  { className: (0, i.Z)("col", "col--8", N) },
                  !!O.totalResults && d(O.totalResults),
                ),
                n.createElement(
                  "div",
                  { className: (0, i.Z)("col", "col--4", "text--right", I) },
                  n.createElement(
                    "a",
                    {
                      target: "_blank",
                    ...
                    n.createElement(
                      "svg",
                      { viewBox: "0 0 168 24", className: A },
                      n.createElement(
                        "g",
                        { fill: "none" },
              ...
              O.items.length > 0
                ? n.createElement(
                    ...
                    null,
                    O.items.map((e, t) => {
                      let { title: r, url: a, summary: s, breadcrumbs: c } = e;
                      return n.createElement(
                        "article",
                        { key: t, className: S },
                        n.createElement(
                ...
                : [
                    ...
                    !!O.loading &&
                      n.createElement("div", { key: "spinner", className: q }),
                  ],
              O.hasMore &&
                n.createElement(
                  "div",
