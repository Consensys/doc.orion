  ...
  [918],
  {
    ...
    1310: (e, t, n) => {
      ...
      function g(e) {
        ...
        return a
          ? o.createElement("span", { className: r, itemProp: "name" }, t)
          : n
          ? o.createElement(
              i.Z,
              { className: r, href: n, itemProp: "item" },
              o.createElement("span", { itemProp: "name" }, t),
            )
          : o.createElement("span", { className: r }, t);
      }
      function b(e) {
      ...
      function v() {
        ...
        return e
          ? o.createElement(
              "nav",
              {
                className: (0, r.Z)(l.k.docs.docBreadcrumbs, h),
                "aria-label": (0, m.I)({
              ...
              o.createElement(
                ...
                e.map((t, n) => {
                  ...
                  return o.createElement(
                    ...
                    o.createElement(g, { href: t.href, isLast: a }, t.label),
                  );
                }),
              ),
            )
    ...
    5824: (e, t, n) => {
              ...
              values: {
                atDate:
                  t && n
                    ...
                    : "",
                byUser: o ? a.createElement(E, { lastUpdatedBy: o }) : "",
              },
            },
      ...
      function C(e) {
        ...
        return a.createElement(
          "a",
          {
            ...
            className: g.k.common.editThisPage,
          },
      ...
      function x(e) {
        ...
        return a.createElement(
          Z.Z,
          { href: t, className: (0, m.Z)(_, o ? w : T) },
          n,
          ...
          a.createElement(
            ...
            t.map((e) => {
              ...
              return a.createElement(
                "li",
                { key: n, className: O },
                a.createElement(x, { label: t, permalink: n }),
              );
            }),
          ),
        );
      ...
      function q(e) {
        ...
        const i = (0, P.L)(),
          ...
          u = (function (e) {
            ...
            return (0, a.useMemo)(
              () => z({ toc: U(t), minHeadingLevel: n, maxHeadingLevel: o }),
              [t, n, o],
            );
        ...
        return (
          ...
          a.createElement(
            F,
            (0, k.Z)({ toc: u, className: n, linkClassName: o }, s),
          )
        );
      }
      ...
      function J(e) {
        ...
        return a.createElement(
          "button",
          (0, k.Z)({ type: "button" }, n, {
            className: (0, m.Z)("clean-btn", G, !t && Y, n.className),
          }),
          a.createElement(
            b.Z,
            {
      ...
      function ee(e) {
        ...
        const { collapsed: l, toggleCollapsed: c } = (0, I.u)({
          initialState: !0,
        });
        return a.createElement(
          "div",
      ...
      function ve(e, t) {
        ...
        if (r && he.test(r)) {
          const e = r.match(he).groups.range;
          if (0 === o.length)
            throw new Error(
        ...
        const l = (function (e, t) {
            switch (e) {
              ...
              case "ts":
              case "typescript":
                return be(["js", "jsBlock"], t);
              case "jsx":
              case "tsx":
                return be(["js", "jsBlock", "jsx"], t);
              case "html":
                return be(["js", "jsBlock", "html"], t);
              case "python":
              case "py":
              case "bash":
                return be(["bash"], t);
              case "markdown":
              case "md":
                return be(["html", "jsx", "bash"], t);
              default:
                return be(Object.keys(ge), t);
            }
          })(a, o),
          c = n.split("\n"),
      ...
      const Ee = "codeBlockContainer_Ckt0";
      function ye(e) {
        let { as: t, ...n } = e;
        const o = (function (e) {
          const t = {
        ...
        return a.createElement(
          ...
          (0, k.Z)({}, n, {
            style: o,
            className: (0, m.Z)(n.className, Ee, g.k.common.codeBlock),
          }),
        );
      }
      const ke = {
      ...
      function Ne(e) {
        ...
        return a.createElement(
          ye,
          {
            as: "pre",
            tabIndex: 0,
            className: (0, m.Z)(ke.codeBlockStandalone, "thin-scrollbar", n),
          },
          a.createElement("code", { className: ke.codeBlockLines }, t),
        );
      }
      const Le = {
        attributes: !0,
      ...
      var _e = { Prism: n(7410).Z, theme: Ze };
      function Te(e, t, n) {
        return (
          t in e
            ? Object.defineProperty(e, t, {
      ...
      var xe = /\r\n|\r|\n/,
        ...
        Ae = function (e, t) {
          ...
          return (
            (o.root = n), (o.plain = we({}, n, { backgroundColor: null })), o
          );
        };
      function je(e, t) {
        var n = {};
      ...
      const He = (function (e) {
          function t() {
            for (var t = this, n = [], a = arguments.length; a--; )
              n[a] = arguments[a];
            e.apply(this, n),
              Te(this, "getThemeDict", function (e) {
                if (
                  void 0 !== t.themeDict &&
                  e.theme === t.prevTheme &&
                ...
                var n = e.theme ? Ae(e.theme, e.language) : void 0;
                return (t.themeDict = n);
              }),
              Te(this, "getLineProps", function (e) {
                var n = e.key,
                  a = e.className,
                  o = e.style,
                  r = we({}, je(e, ["key", "className", "style", "line"]), {
                ...
                return (
                  ...
                  void 0 !== o &&
                    (r.style = void 0 !== r.style ? we({}, r.style, o) : o),
                  void 0 !== n && (r.key = n),
                  a && (r.className += " " + a),
                  r
                );
              }),
              Te(this, "getStyleForToken", function (e) {
                var n = e.types,
                  a = e.empty,
                  o = n.length,
              ...
              Te(this, "getTokenProps", function (e) {
                var n = e.key,
                  a = e.className,
                  o = e.style,
                  r = e.token,
                  l = we({}, je(e, ["key", "className", "style", "token"]), {
                ...
                return (
                  void 0 !== o &&
                    (l.style = void 0 !== l.style ? we({}, l.style, o) : o),
                  void 0 !== n && (l.key = n),
                  a && (l.className += " " + a),
                  l
                );
              }),
              Te(this, "tokenize", function (e, t, n, a) {
                    ...
                    for (; (r = a[l]++) < o[l]; ) {
                      ...
                      if (
                        ...
                        for (var f = 1; f < p; f++)
                          Be(c),
                            s.push((c = [])),
                            c.push({ types: m, content: u[f] });
                      } else
                        l++, t.push(m), n.push(i), a.push(0), o.push(i.length);
                    }
        ...
        Se = "codeLine_lJS_",
        Me = "codeLineNumber_Tfdd",
        Ie = "codeLineContent_feaV";
      function Pe(e) {
        let {
          line: t,
          classNames: n,
        ...
        const c = r({ line: t, className: (0, m.Z)(n, o && Se) }),
          s = t.map((e, t) =>
            a.createElement(
              "span",
              (0, k.Z)({ key: t }, l({ token: e, key: t })),
            ),
          );
        return a.createElement(
          "span",
          ...
          o
            ? a.createElement(
                ...
                a.createElement("span", { className: Ie }, s),
              )
            : s,
        ...
        const [o, r] = (0, a.useState)(!1),
          ...
          c = (0, a.useCallback)(() => {
            !(function (e, t) {
              ...
              let l = !1;
              r.rangeCount > 0 && (l = r.getRangeAt(0)),
                n.append(a),
                a.select(),
                (a.selectionStart = 0),
              ...
              a.remove(),
                l && (r.removeAllRanges(), r.addRange(l)),
                o && o.focus();
            })(t),
              r(!0),
          ...
          a.createElement(
            "button",
            {
              ...
              className: (0, m.Z)(
                ...
                n,
                Ue.copyButton,
                o && Ue.copyButtonCopied,
              ),
              onClick: c,
            },
            a.createElement(
              "span",
              { className: Ue.copyButtonIcons, "aria-hidden": "true" },
              a.createElement(
                "svg",
                { className: Ue.copyButtonIcon, viewBox: "0 0 24 24" },
                a.createElement("path", {
              ...
              a.createElement(
                "svg",
                { className: Ue.copyButtonSuccessIcon, viewBox: "0 0 24 24" },
                a.createElement("path", {
      ...
      const Ve = "wordWrapButtonIcon_Bwma",
        De = "wordWrapButtonEnabled_EoeP";
      function Re(e) {
        ...
        return a.createElement(
          "button",
          {
            type: "button",
            onClick: n,
            className: (0, m.Z)("clean-btn", t, o && De),
            "aria-label": r,
            title: r,
          },
          a.createElement(
            "svg",
            { className: Ve, viewBox: "0 0 24 24", "aria-hidden": "true" },
            a.createElement("path", {
              fill: "currentColor",
      ...
      function $e(e) {
        ...
        const u = de(),
          ...
          f =
            (function (e) {
              return e?.match(fe)?.groups.title ?? "";
            })(o) || r,
          { lineClassNames: h, code: g } = ve(t, {
            metastring: o,
            language: d,
            magicComments: i,
          }),
        ...
        return a.createElement(
          ye,
          {
            ...
            className: (0, m.Z)(
              n,
              d && !n.includes(`language-${d}`) && `language-${d}`,
            ),
          },
          f && a.createElement("div", { className: ke.codeBlockTitle }, f),
          a.createElement(
            "div",
            { className: ke.codeBlockContent },
            a.createElement(
              He,
              (0, k.Z)({}, _e, { theme: u, code: g, language: d ?? "text" }),
              (e) => {
                let {
                  className: t,
                  tokens: n,
                ...
                return a.createElement(
                  "pre",
                  {
                    tabIndex: 0,
                    ref: p.codeBlockRef,
                    className: (0, m.Z)(t, ke.codeBlock, "thin-scrollbar"),
                  },
                  a.createElement(
                    "code",
                    {
                      className: (0, m.Z)(
                        ke.codeBlockLines,
                        b && ke.codeBlockLinesWithNumbering,
                      ),
                    },
                    n.map((e, t) =>
                      a.createElement(Pe, {
            ...
            a.createElement(
              "div",
              { className: ke.buttonGroup },
              (p.isEnabled || p.isCodeScrollable) &&
                a.createElement(Re, {
                  className: ke.codeButton,
                  onClick: () => p.toggle(),
                  isEnabled: p.isEnabled,
                }),
              a.createElement(ze, { className: ke.codeButton, code: g }),
            ),
          ),
        );
      }
      function We(e) {
        ...
        const o = (0, ie.Z)(),
          ...
          l = "string" == typeof r ? $e : Ne;
        return a.createElement(l, (0, k.Z)({ key: String(o) }, n), r);
      }
      const Fe = "details_lb9f",
        qe = "isBrowser_bmU9",
        Ge = "collapsibleContent_i85q";
      function Ye(e) {
        return !!e && ("SUMMARY" === e.tagName || Ye(e.parentElement));
      }
      function Je(e, t) {
        return !!e && (e === t || Je(e.parentElement, t));
      }
      function Qe(e) {
        let { summary: t, children: n, ...o } = e;
        const r = (0, ie.Z)(),
          l = (0, a.useRef)(null),
          { collapsed: c, setCollapsed: s } = (0, I.u)({
            initialState: !o.open,
          }),
        ...
        return a.createElement(
          ...
          (0, k.Z)({}, o, {
            ...
            open: i,
            "data-collapsed": c,
            className: (0, m.Z)(Fe, r && qe, o.className),
            onMouseDown: (e) => {
              Ye(e.target) && e.detail > 1 && e.preventDefault();
            },
            onClick: (e) => {
              e.stopPropagation();
              const t = e.target;
              Ye(t) &&
                Je(t, l.current) &&
                (e.preventDefault(), c ? (s(!1), d(!0)) : s(!0));
            },
          }),
          ...
          a.createElement(
            ...
            a.createElement("div", { className: Ge }, n),
          ),
        );
      }
      const Xe = "details_b_Ee";
      function Ke(e) {
        let { ...t } = e;
        return a.createElement(
          Qe,
          (0, k.Z)({}, t, {
            className: (0, m.Z)("alert alert--info", Xe, t.className),
          }),
        );
      }
      function et(e) {
        return a.createElement(le.Z, e);
      }
      const tt = "containsTaskList_mC6p";
      const nt = "img_ev3q";
      const at = "admonition_LlT9",
        ot = "admonitionHeading_tbUL",
        rt = "admonitionIcon_kALy",
        ...
        const { mdxAdmonitionTitle: t, rest: n } = (function (e) {
          const t = a.Children.toArray(e),
            n = t.find(
              (e) =>
                a.isValidElement(e) &&
                "mdxAdmonitionTitle" === e.props?.mdxType,
            ),
            o = a.createElement(
              a.Fragment,
              null,
      ...
      const mt = {
        head: function (e) {
          ...
          return a.createElement(se.Z, e, t);
        },
        code: function (e) {
          const t = [
            "a",
        ...
        details: function (e) {
          const t = a.Children.toArray(e.children),
            n = t.find(
              (e) => a.isValidElement(e) && "summary" === e.props?.mdxType,
            ),
            o = a.createElement(
              a.Fragment,
              null,
          ...
          return a.createElement(Ke, (0, k.Z)({}, e, { summary: n }), o);
        },
        ul: function (e) {
          return a.createElement(
            "ul",
            (0, k.Z)({}, e, {
              className:
                ((t = e.className),
                (0, m.Z)(t, t?.includes("contains-task-list") && tt)),
            }),
          );
          var t;
        },
        img: function (e) {
          return a.createElement(
            "img",
            (0, k.Z)({ loading: "lazy" }, e, {
              className: ((t = e.className), (0, m.Z)(t, nt)),
            }),
          );
          var t;
        },
        h1: (e) => a.createElement(et, (0, k.Z)({ as: "h1" }, e)),
        h2: (e) => a.createElement(et, (0, k.Z)({ as: "h2" }, e)),
        h3: (e) => a.createElement(et, (0, k.Z)({ as: "h3" }, e)),
        h4: (e) => a.createElement(et, (0, k.Z)({ as: "h4" }, e)),
        h5: (e) => a.createElement(et, (0, k.Z)({ as: "h5" }, e)),
        h6: (e) => a.createElement(et, (0, k.Z)({ as: "h6" }, e)),
        admonition: function (e) {
          const { children: t, type: n, title: o, icon: r } = it(e),
            l = (function (e) {
              const t = st[e] ?? e,
                n = ct[t];
              return (
          ...
          return a.createElement(
            ...
            {
              className: (0, m.Z)(
                g.k.common.admonition,
                g.k.common.admonitionType(e.type),
                "alert",
            ...
            a.createElement(
              "div",
              { className: ot },
              a.createElement("span", { className: rt }, i),
              c,
            ),
      ...
      function dt(e) {
        let { children: t } = e;
        return a.createElement(ce.Zo, { components: mt }, t);
      }
      function ut(e) {
        let { children: t } = e;
        const n = (function () {
      ...
      function gt(e) {
        ...
        const n = (function () {
          ...
          return {
            hidden: o,
            mobile: r ? a.createElement(ne, null) : void 0,
            desktop:
              !r || ("desktop" !== n && "ssr" !== n)
                ? void 0
        ...
        return a.createElement(
          ...
          a.createElement(
            "div",
            { className: (0, m.Z)("col", !n.hidden && ht) },
            ...
            a.createElement(
              ...
              a.createElement(
                "article",
                null,
                a.createElement(pt.Z, null),
                a.createElement(h.Z, null),
                n.mobile,
                a.createElement(ut, null, t),
      ...
      function bt(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(gt, null, a.createElement(n, null)),
          ),
        );
      }
    },
    4966: (e, t, n) => {
      ...
      function s(e) {
        ...
        return o.createElement(
          ...
          o.createElement("div", { className: "pagination-nav__label" }, n),
        );
      }
      function i(e) {
    ...
    3120: (e, t, n) => {
      ...
      function h(e) {
        ...
        const {
          ...
          g = u ?? (b = h).docs.find((e) => e.id === b.mainDocId);
        var b;
        return a.createElement(
          "div",
          {
          ...
          a.createElement(
            "div",
            null,
            a.createElement(p, { siteTitle: l, versionMetadata: n }),
          ),
          a.createElement(
            "div",
      ...
      function g(e) {
        ...
        const n = (0, d.E)();
        return n.banner
          ? a.createElement(h, { className: t, versionMetadata: n })
          : null;
      }
    },
    2503: (e, t, n) => {
      ...
      function d(e) {
        ...
        if ("h1" === t || !n)
          return o.createElement(t, (0, a.Z)({}, d, { id: void 0 }));
        const p = (0, l.I)(
          {
        ...
        return o.createElement(
          t,
          (0, a.Z)({}, d, {
            className: (0, r.Z)("anchor", u ? m : i, d.className),
            id: n,
          }),
          d.children,
          o.createElement(
            s.Z,
            { className: "hash-link", to: `#${n}`, "aria-label": p, title: p },
            "\u200b",
          ),
        );
      }
